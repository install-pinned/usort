...
This action installs a pinned version of **usort** and all its dependencies,         making sure that file hashes match. Pinning your dependencies:
...
```yaml
      - name: Install usort from PyPI
        uses: install-pinned/usort@6de13bc28819474faadaee341ae926580925c3cd  # 1.0.5
```
